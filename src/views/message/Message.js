...
function Message() {
  ...
  const [messages, setMessages] = useState([
    {
      ...
      message:
        "Hi. My name is Justin Roiland. I am Creator  of Rick and Morty and I wanted you to meet many characters. Just say Hello ! ",
    },
    {
      name: "Koray izlimek",
      imageUrl:
      ...
      message: "Hi, this page is static. I have no API. Sorry Bro.",
    },
    {
      message: "OK. Bro. No Problem.",
    },
  ]);
  ...
  return (
    <div className="chatScreen">
      <p className="chatScreen-timestamp">You match with Justin</p>
      {messages.map((message) =>
        message.name ? (
          <div className="chatScreen-message">
            <img
              className="chatScreen-message-image"
              src={message.imageUrl}
              alt="ImageUrl"
            />
            <p className="chatScreen-message-text">{message.message}</p>
          </div>
        ) : (
          <div className="chatScreen-message">
            <p className="chatScreen-message-user-text">
              {message.message}
            </p>
          </div>
        )
      ...
      <form className="chatScreen-input">
        <input
          ...
          type="text"
        />
        <button onClick={handleSend} className="chatScreen-input-buttom">
          Gonder
        </button>
      </form>
    </div>
